...
--
-- Хост: 127.0.0.1
-- Время создания: Сен 26 2017 г., 12:36
...
--
-- Ограничения внешнего ключа таблицы `pizza_booking_connect`
--
ALTER TABLE `pizza_booking_connect`
  ADD CONSTRAINT `pizza_booking_connect_ibfk_1` FOREIGN KEY (`goods_id`) REFERENCES `pizza_goods` (`goods_id`),
  ADD CONSTRAINT `pizza_booking_connect_ibfk_2` FOREIGN KEY (`booking_id`) REFERENCES `pizza_booking` (`booking_id`);
